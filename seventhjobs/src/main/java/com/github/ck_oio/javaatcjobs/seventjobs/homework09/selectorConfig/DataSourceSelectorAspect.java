...
public class DataSourceSelectorAspect {
     ...
     * 配置切点
     */
    @Pointcut("@annotation(com.github.ck_oio.javaatcjobs.seventjobs.homework09.selectorConfig.DataSourceSelector)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable{
        ...
        if(selector != null){
            RoutingDataSource.setDataSourceType(selector.value());
        ...
        try{
            ...
            RoutingDataSource.removeDataSourceType();
